...
my $view = Database::Accessor::View->new({name  => 'person',alias => 'test'});
ok( ref($view) eq 'Database::Accessor::View', "Person is a View" );
ok( does_role($view,"Database::Accessor::Roles::Alias") eq 1,"View does role Database::Accessor::Roles::Alias");
...
is(
  exception {Database::Accessor::View->new({name => 'person'}) },
  undef,
  "attribute alias is not a requied field"
);
